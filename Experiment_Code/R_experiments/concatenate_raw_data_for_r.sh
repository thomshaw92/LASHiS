...
for subjName in `cat ${github_dir}/ADNI_code/subjnames_2_ses.csv` ; do
    ...
    #FsLong
    cp ${base_dir}/Freesurfer/${subjName}_ses_ses-01/mri/lh.hippoSfVolumes-T1.long.v21.txt $base_dir/Freesurfer/${subjName}_Freesurfer/FsLong/mprage1${side}SSTLabelsWarpedToTimePoint0_stats.txt
    cp ${base_dir}/Freesurfer/${subjName}_ses_ses-02/mri/lh.hippoSfVolumes-T1.long.v21.txt $base_dir/Freesurfer/${subjName}_Freesurfer/FsLong/mprage2${side}SSTLabelsWarpedToTimePoint1_stats.txt
    cp ${base_dir}/Freesurfer/${subjName}_ses_ses-03/mri/lh.hippoSfVolumes-T1.long.v21.txt $base_dir/Freesurfer/${subjName}_Freesurfer/FsLong/mprage3${side}SSTLabelsWarpedToTimePoint2_stats.txt

    cp ${base_dir}/Freesurfer/${subjName}_ses_ses-01/mri/rh.hippoSfVolumes-T1.long.v21.txt $base_dir/Freesurfer/${subjName}_Freesurfer/FsLong/mprage1${side}SSTLabelsWarpedToTimePoint0_stats.txt
    cp ${base_dir}/Freesurfer/${subjName}_ses_ses-02/mri/rh.hippoSfVolumes-T1.long.v21.txt $base_dir/Freesurfer/${subjName}_Freesurfer/FsLong/mprage2${side}SSTLabelsWarpedToTimePoint1_stats.txt
    cp ${base_dir}/Freesurfer/${subjName}_ses_ses-03/mri/rh.hippoSfVolumes-T1.long.v21.txt $base_dir/Freesurfer/${subjName}_Freesurfer/FsLong/mprage3${side}SSTLabelsWarpedToTimePoint2_stats.txt
