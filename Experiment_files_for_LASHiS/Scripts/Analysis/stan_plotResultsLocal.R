...
baseDirectory <-'/home/uqayork/Desktop/LASHiS/Experiment_Code/R_experiments/LME_experiment/'
...
hippoVolumePipelineNames <- c( 'FsXs', 'ashs_xs', 'FsLongDummy', 'Diet_LASHiS', 'LASHiS')
numberOfRegions <- 8
